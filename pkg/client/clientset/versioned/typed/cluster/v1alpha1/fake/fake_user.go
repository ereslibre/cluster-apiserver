...
import (
	v1alpha1 "github.com/ereslibre/cluster-apiserver/pkg/apis/cluster/v1alpha1"
...
var usersResource = schema.GroupVersionResource{Group: "cluster.k8s.io", Version: "v1alpha1", Resource: "users"}

var usersKind = schema.GroupVersionKind{Group: "cluster.k8s.io", Version: "v1alpha1", Kind: "User"}

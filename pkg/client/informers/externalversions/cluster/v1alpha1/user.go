...
import (
	...
	clusterv1alpha1 "github.com/ereslibre/cluster-apiserver/pkg/apis/cluster/v1alpha1"
	versioned "github.com/ereslibre/cluster-apiserver/pkg/client/clientset/versioned"
	internalinterfaces "github.com/ereslibre/cluster-apiserver/pkg/client/informers/externalversions/internalinterfaces"
	v1alpha1 "github.com/ereslibre/cluster-apiserver/pkg/client/listers/cluster/v1alpha1"
	...
	return cache.NewSharedIndexInformer(
		&cache.ListWatch{
			ListFunc: func(options v1.ListOptions) (runtime.Object, error) {
				...
				return client.ClusterV1alpha1().Users().List(options)
			},
			WatchFunc: func(options v1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.ClusterV1alpha1().Users().Watch(options)
			},
		},
		&clusterv1alpha1.User{},
		resyncPeriod,
		indexers,
	)
}
...
func (f *userInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&clusterv1alpha1.User{}, f.defaultInformer)
}
